                ...
                <div class="widget widget-shadow" id="widgetLineareaFour">
                    <div class="widget-content">
                        <div class="padding-20 padding-top-10">
                            <div class="clearfix">
                                <div class="grey-800 pull-left padding-vertical-10">
                                    <i class="icon md-view-list grey-600 font-size-24 vertical-align-bottom margin-right-5"></i>
                                    Items
                                </div>
                                <span class="pull-right grey-700 font-size-30">845</span>
                            </div>
                            <div class="margin-bottom-20 grey-500">
                                <i class="icon md-long-arrow-up green-500 font-size-16"></i> 18.4% From this
                                yesterday
                            </div>
                            <div class="ct-chart height-50"></div>
                        </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="widget" id="widgetUserList">
                    <div class="widget-header cover overlay">
                        <img class="cover-image height-200" src="images/dashboard-header.jpg"
                             alt="..."/>
                        <div class="overlay-panel vertical-align overlay-background">
                            <div class="vertical-align-middle">
                                ...
                                <div class="pull-left">
                                    <div class="font-size-20">Markov Bruno</div>
                                    <p class="margin-bottom-20 text-nowrap">
                                        <span class="text-break">4652417@gmail</span>
                                    </p>
                    ...
                    <div class="widget-content padding-vertical-20">
                        <div class="widget-chat-header">
                            ...
                            <div class="text-right">
                                ...
                                <a class="avatar margin-left-15" data-toggle="tooltip" href="#"
                ...
                <div class="widget widget-shadow">
                    <div class="widget-header cover overlay">
                        <div class="cover-background height-200"
                             style="background-image: url('images/placeholder.png')"></div>
                    </div>
                    <div class="widget-body padding-horizontal-30 padding-vertical-20"
