                    ...
                    <div class="panel-actions">
                        <div class="item-actions">
                            <span class="btn btn-pure btn-icon waves-effect waves-classic" data-toggle="list-editable">
                                <?= Html::a('<i class="icon md-arrow-left"></i>', ['/']) ?>
                            </span>
                            <span class="btn btn-pure btn-icon waves-effect waves-classic" data-toggle="list-editable">
                        ...
                        <div class="col-lg-5">
                            <p>
                                ...
                                <? if (User::hasRole('Reception') || User::hasRole('call-center')) { ?>
                                    <? if ($model->instance_id == 0 || $model->instance_id == 5 || $model->instance_id == 6 || $model->instance_id == 7) { ?>
                                        <?= Html::button(Yii::t('main', 'Qayta urunish'), ['value' => Url::to(['/reception/change-instance', 'id' => $model->id]), 'class' => 'btn btn-info modalButton']) ?>
                                    <? } ?>
                                <? } ?>
                            </p>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td class="text-middle"><?= Yii::t('main', 'Call Side') ?></td>
                                    <td><?= Yii::$app->params['call_side'][$model->call_side] ?></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?= $model->date_coming == '0000-00-00 00:00:00' ? '-' : $model->date_coming ?></td>
                                </tr>
                                <tr>
                                ...
                                <div id="examplePanel" class="panel margin-bottom-0">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><?= Yii::t('main', 'Call Name') ?>
                                            - <?= \Yii::$app->params['call_name'][$model->call_name] ?></h3>
                                    </div>
                                    <div class="panel-body">

                                        <div class="chats-wrap">
                                            <div class="chats" style="height: 250px; overflow: scroll">
                                                <?
